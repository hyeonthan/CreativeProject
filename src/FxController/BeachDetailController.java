...
public class BeachDetailController implements Initializable {
	...
	@FXML public TableView<Review> tv_review;
	@FXML public TableColumn<Review, String> tc_date;
	@FXML public TableColumn<Review, String> tc_content;
	@FXML public TableColumn<Review, Double> tc_star;
	@FXML public TableColumn<Review, String> tc_writer;
